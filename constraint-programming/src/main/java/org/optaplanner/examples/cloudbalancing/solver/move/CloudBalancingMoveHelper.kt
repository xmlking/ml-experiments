...
object CloudBalancingMoveHelper {

    fun moveCloudComputer(scoreDirector: ScoreDirector, cloudProcess: CloudProcess,
                          toCloudComputer: CloudComputer) {
        scoreDirector.beforeVariableChanged(cloudProcess, "computer")
        cloudProcess.computer = toCloudComputer
